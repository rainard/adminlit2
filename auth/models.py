...
class OperLogs( models.Model ):
    user = models.ForeignKey( User, verbose_name='用户', on_delete=models.PROTECT )
    path = models.CharField( u'Url', max_length=256 )
    log_datetime = models.DateTimeField( u'记录时间' )
    pars = models.CharField(u'参数',max_length=1024,null=True,blank=True)
